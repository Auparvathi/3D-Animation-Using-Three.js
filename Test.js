...
var geometry_r = new THREE.RingGeometry( 60, 75, 52 );
var texture_r = new THREE.TextureLoader().load( 'saturnringcolor.jpg' );
...
function animate(){
    //Rotating the earth about itself and revolution
     ...
     raycaster.setFromCamera (mouse, camera);//mouse is origin and camera is  destination for ray of light
     const intersects = raycaster.intersectObjects ([mer,ven,earth,mar,jup,sat,ura,nep]); //,ven,earth,mar,jup,sat,ura,nep
     console.log(intersects);
     if (intersects[0]){ //,1,2,3,4,5,6,7
        console.log(intersects[0].object.geometry.id); //,1,2,3,4,5,6,7
        switch(intersects[0].object.geometry.id){//,1,2,3,4,5,6,7
           
             case 16:{
                console.log('mer flag');
                mer_flag=1;
             ...
             case 20:{
                console.log('mar flag');
                mar_flag=1;
                
                break;
             }
             case 21:{
                console.log('jup flag');
                jup_flag=1;
             ...
             case 22:{
                console.log('sat flag');
                sat_flag=1;
                
                break;
             }
             case 24:{
                console.log('ura flag');
                ura_flag=1;
                
                break;
             }
             case 25:{
                console.log('nep flag');
                nep_flag=1;
    ...
    if (mer_flag==1) {
        FollowPlanet(mer);
        document.getElementById('mer_text').style.display = 'block'

        
    } 
    else if (ven_flag==1) {
        FollowPlanet(ven);
        document.getElementById('ven_text').style.display = 'block'
        ...
        FollowPlanet(mar);
        document.getElementById('mar_text').style.display = 'block'
        
    } 
    else if (jup_flag==1) {
        FollowPlanet(jup);
        document.getElementById('jup_text').style.display = 'block'

        
    } 
    else if (sat_flag==1) {
        FollowPlanet(sat);
        document.getElementById('sat_text').style.display = 'block'

        
    } 
    else if (ura_flag==1) {
        FollowPlanet(ura);
        document.getElementById('ura_text').style.display = 'block'

        
    } 
    else if (nep_flag==1) {
        FollowPlanet(nep);
        document.getElementById('nep_text').style.display = 'block'
